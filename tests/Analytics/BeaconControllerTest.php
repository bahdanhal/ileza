...
final class BeaconControllerTest extends TestCase
{
    ...
    public function testValidBeaconRecordsPageView(): void
    {
        ...
        $controller = new BeaconController($repository, 'analytics-secret');
        $payload = json_encode(['p' => '/pl/ceny-uzywane-elektroniki', 'r' => 'https://google.com/search?q=test'], JSON_THROW_ON_ERROR);
        ...
        self::assertSame('/pl/ceny-uzywane-elektroniki', $stored->path);
    ...
    public function testExcludesStealthScraperGreaseHeaders(): void
    {
        ...
        $controller = new BeaconController($repository, 'analytics-secret');
        $payload = json_encode(['p' => '/pl/ceny-uzywane-elektroniki'], JSON_THROW_ON_ERROR);
        $request = Request::create(
            'https://ileza.pl/api/pa/hit',
            'POST',
            server: [
